      ...
      <div className="max-w-md w-full space-y-12 py-12">
        <header className="text-center space-y-4">
          ...
          <p className="text-gray-500 font-medium text-sm">
            Or <Link href="/login" className="text-primary font-bold hover:underline">sign in instead</Link>
          </p>
        </header>
        ...
        <form className="space-y-8" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <p className="text-center text-xs font-medium text-gray-400 max-w-xs mx-auto">
              By joining, you agree to our Scholar community guidelines and terms.
            </p>
          </div>
        </form>
      </div>
